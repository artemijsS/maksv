    ...
    return (
        <div className={style.filterSection + " wrapper"}>
            ...
            <form onSubmit={onSubmit} className={style.filter + " " + `${mobOpen ? style.mobOpen : ""}`}>
                ...
                <div className={style.row}>
                    <div className={style.input + " " + style.long}>
                        ...
                        <input type="text" id={"search"} value={filter.search} onChange={e => setFilter({...filter, search: e.target.value})} placeholder={"Meklējamais vārds vai frāze"}/>
                    </div>
                    <div className={style.input}>
                        <label htmlFor="oprtation">Operācija</label>
                        <Select
                            options={[{option: "Pirkt uzreiz", value: "0"}, {option: "Iziret", value: "1"}]}
                            placeHolder={"-"}
                    ...
                    <button type={"submit"} className={style.pcSubmit}>Meklēt</button>
                </div>
                    ...
                    <>
                        <div className={style.row} style={{ marginTop: '20px' }}>
                            ...
                            <div className={style.input + " " + style.small}>
                                ...
                                <input type="number" placeholder={"Cena no"} value={filter.priceFrom} onChange={e => setFilter({...filter, priceFrom: e.target.value})}/>
                            </div>
                            <div className={style.input + " " + style.small}>
                                <input type="number" placeholder={"Cena līdz"} value={filter.priceTill} onChange={e => setFilter({...filter, priceTill: e.target.value})}/>
                            </div>
                        ...
                        {type &&
                            <div className={style.row} style={{ marginTop: '20px' }}>
                                {type === '1' &&
                                    <>
                                        <div className={style.input + " " + style.small}>
                                            ...
                                            <input type="number" id={"floor"} value={filter.floorFrom} onChange={e => setFilter({...filter, floorFrom: e.target.value})} placeholder={"No"}/>
                                        </div>
                                        <div className={style.input + " " + style.small}>
                                            <input type="number" value={filter.floorTill} onChange={e => setFilter({...filter, floorTill: e.target.value})} placeholder={"Līdz"}/>
                                        </div>
                                    </>
                                }
                                {(type === '2' || type === '10') &&
                                ...
                                <>
                                    <div className={style.input + " " + style.small}>
                                        <label htmlFor="rooms">Istabas</label>
                                        <input type="number" id={"rooms"} value={filter.roomsFrom} onChange={e => setFilter({...filter, roomsFrom: e.target.value})} placeholder={"No"}/>
                                    </div>
                                    <div className={style.input + " " + style.small}>
                                        <input type="number" value={filter.roomsTill} onChange={e => setFilter({...filter, roomsTill: e.target.value})} placeholder={"Līdz"}/>
                                    </div>
                                </>
                                }
                                {(type === '1' || type === '2')  &&
                                <>
                                    <div className={style.input + " " + style.small}>
                                        ...
                                        <input type="number" id={"livingArea"} value={filter.livingAreaFrom} onChange={e => setFilter({...filter, livingAreaFrom: e.target.value})} placeholder={"No"}/>
                                    </div>
                                    <div className={style.input + " " + style.small}>
                                        <input type="number" value={filter.livingAreaTill} onChange={e => setFilter({...filter, livingAreaTill: e.target.value})} placeholder={"Līdz"}/>
                                    </div>
                                </>
                                }
                                ...
                                <>
                                    <div className={style.input + " " + style.small}>
                                        ...
                                        <input type="number" id={"landArea"} value={filter.landAreaFrom} onChange={e => setFilter({...filter, landAreaFrom: e.target.value})} placeholder={"No"}/>
                                    </div>
                                    <div className={style.input + " " + style.small}>
                                        <input type="number" value={filter.landAreaTill} onChange={e => setFilter({...filter, landAreaTill: e.target.value})} placeholder={"Līdz"}/>
                                    </div>
                                </>
                                }
                                {type === '2' &&
                                <>
                                    <div className={style.input + " " + style.small}>
                                        <label htmlFor="series">Sērija</label>
                                        <Select
                                ...
                                <>
                                    <div className={style.input + " " + style.small}>
                                        ...
                                        <input type="number" id={"gateHeight"} value={filter.gateHeightFrom} onChange={e => setFilter({...filter, gateHeightFrom: e.target.value})} placeholder={"No"}/>
                                    </div>
                                    <div className={style.input + " " + style.small}>
                                        <input type="number" value={filter.gateHeightTill} onChange={e => setFilter({...filter, gateHeightTill: e.target.value})} placeholder={"Līdz"}/>
                                    </div>
                                </>
                                }
                            </div>
                        }
                        <button className={style.reset} onClick={() => reset()}>Dzēst</button>
                    </>
                }
            ...
            <div className={style.sort}>
                ...
                <Select
                    options={[{option: "Cēna dilstošā", value: "price:desc"},
                        {option: "Cēna augstošā", value: "price:asc"},
                        {option: "Datums dilstošā", value: "createdAt:desc"},
                        {option: "Datums augstošā", value: "createdAt:asc"}]}
                    placeHolder={""}
